...
var OverlayView = (exports.OverlayView = (function(_React$PureComponent) {
  ...
  function OverlayView(props, context) {
    ...
    overlayView.getPosition = function() {
      return new google.maps.LatLng(props.position)
    }
    overlayView.getDraggable = function() {}
    ...
    if (markerClusterer) {
      markerClusterer.addMarker(overlayView, !!_this.props.noRedraw)
    } else {
  ...
  ;(0, _createClass3.default)(OverlayView, [
    ...
    },
    {
      ...
      value: function getPosition() {
        return this.state[_constants.OVERLAY_VIEW].getPosition()
      },
    },
  ])
  return OverlayView
